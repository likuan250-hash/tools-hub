...
# ── 后端逻辑(与 netdisk-hub control_panel_tk.py 一致) ────────────────
def find_pid():
...
class Panel(tk.Tk):
    ...
    def _build(self):
        ...
        tk.Label(hdr, text="多维表录入", bg=BG, fg=TXT,
